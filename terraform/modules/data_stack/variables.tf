...
# Era false ate o Dataform materializar rpt_label_coverage_by_component/rpt_unlabeled_resources
# pela 1a vez (bloqueado pelo grant de TI em stg_billing_platform, que le a tabela bruta do
# billing export; ver docs/adr/ADR-003). Confirmado em 2026-09-14 que as 2 views existem em
# reporting_dev e reporting_prod (1a carga do dev-daily/prod-daily, com o fix de
# assert_fct_reconciliation — ver PRs #19, #23, #24) — true a partir daqui.
